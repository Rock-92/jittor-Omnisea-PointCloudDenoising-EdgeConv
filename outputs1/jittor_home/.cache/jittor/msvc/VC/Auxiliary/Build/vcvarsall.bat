...
:end
@REM set __VCVARSALL_TARGET_ARCH=
@REM set __VCVARSALL_HOST_ARCH=
@REM set __VCVARSALL_STORE=
@REM set __VCVARSALL_WINSDK=
@REM set __VCVARSALL_PARSE_ERROR=
@REM set __VCVARSALL_CLEAN_ENV=
@REM set VSCMD_VCVARSALL_INIT=
@REM set __VCVARSALL_VSDEVCMD_ARGS=
@REM set __VCVARSALL_HELP=
@REM set __VCVARSALL_VER=
@REM set __VCVARSALL_SPECTRE=
set FUCK=1